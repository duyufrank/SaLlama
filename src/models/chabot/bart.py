...
from transformers import BartTokenizer,LlamaTokenizer,LlamaConfig
...
class MyBart(BaseTransformer):
    ...
    def _custom_init(self):
        ...
        # model
        self.model = self._load_model(self.hparams.model_name_or_path, LlamaForCausalLM, self.config,load_in_8bit=True)
